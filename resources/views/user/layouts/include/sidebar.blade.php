<nav id="sidebar" class="">
    <div class="sidebar-header">
        <a href="index.html"><img class="main-logo" src="{{ asset('/public/user/img/logo/logo.png') }}" alt="" /></a>
        <strong><img src="{{asset('/public/user/img/logo/logosn.png')}}" alt="" /></strong>
    </div>
    <div class="nalika-profile">
        <div class="profile-dtl">
            <a href="#"><img src="{{ asset('/public/user/img/notification/4.jpg') }}" alt="" /></a>
            <h2>{{ Auth::user()->name }} <span class="min-dtn">Dasboard</span></h2>
        </div>
    </div>
